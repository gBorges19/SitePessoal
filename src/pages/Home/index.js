...
import { 
    ...
    ButtonHide, ButtonShow, ContainerFront, ContainerData, ContainerGames, ContainerNeutro, FieldCertificado, TitleCertificado
...
function Home(){
    ...
    const showNeutro = () => {
        document.getElementById('neutro').style.display = 'flex';
    }
        ...
        <GlobalContainer>
            ...
            <RowContainer>
                ...
                <ButtonContainer>
                    ...
                    <Button href='https://github.com/gBorges19' target='_blank' rel='noreferrer'>Acessar Portfólio</Button>
            ...
            <RowContainer>
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-certificate" width="44" height="44" viewBox="0 0 24 24" stroke-width="2" stroke="#5c8f6a" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
            ...
            <RowContainer>
                ...
                <FieldCertificado>
                    <SimpleRow>
                        <TitleCertificado>Dev Front-End</TitleCertificado>
                        <ButtonHide onClick={() => hideFront()}>-</ButtonHide>
                        <ButtonShow onClick={() => showFront()}>+</ButtonShow>
                    </SimpleRow>
                    <ContainerFront id='front'>
                        <p>oi</p>
                    </ContainerFront>
                </FieldCertificado>
                ...
                <FieldCertificado>
                    <SimpleRow>
                        <TitleCertificado>Data Science e IA</TitleCertificado>
                        <ButtonHide onClick={() => hideData()}>-</ButtonHide>
                        <ButtonShow onClick={() => showData()}>+</ButtonShow>
                    </SimpleRow>
                    <ContainerData id='data'>
                        <p>oi</p>
                    </ContainerData>
                </FieldCertificado>
            ...
            <RowContainer>
                ...
                <FieldCertificado>
                    <SimpleRow>
                        <TitleCertificado>Game Design</TitleCertificado>
                        <ButtonHide onClick={() => hideGames()}>-</ButtonHide>
                        <ButtonShow onClick={() => showGames()}>+</ButtonShow>
                    </SimpleRow>
                    <ContainerGames id='games'>
                        <p>oi</p>
                    </ContainerGames>
                </FieldCertificado>
                ...
                <FieldCertificado>
                    <SimpleRow>
                        <TitleCertificado>Complementares</TitleCertificado>
                        <ButtonHide onClick={() => hideNeutro()}>-</ButtonHide>
